...
**Project**: friendly-gringos-portal 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: imitation of www.5gringos.com 
...
```sh
git clone https://github.com/GPT-Engineer-App/friendly-gringos-portal.git
cd friendly-gringos-portal
npm i
